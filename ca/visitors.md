...
layout: page
title: VIsitants
description: Donem la benvinguda als practicants d’aikido de tot el món que visiteu Barcelona i desitgeu entrenar amb nosaltres. Tant si veniu per una estada curta com si esteu considerant unir-vos al nostre dojo, ens complau rebre-us.
...
## Entrenar com a visitant

Totes les persones són benvingudes.
...
- El nom del vostre dojo
- El vostre grau
- El nom del vostre instructor
- La data i les classes en què voleu participar

Això ens ajuda a preparar-nos i a assegurar una experiència fluida per a tothom al tatami.

## Si voleu observar una classe

- Feu-nos saber amb antelació el dia i la classe que voleu observar.
- Arribeu almenys __15 minuts abans__ que comenci la classe.

L’observació és una bona opció si sou nous al dojo, veniu per poc temps o simplement teniu curiositat per la nostra pràctica.

## Si voleu unir-vos a Aikido Musubi

__Principiants__<br>
Si sou nous en l’aikido, recomanem assistir a una __classe per a principiants__ abans de sol·licitar formalment unir-vos al dojo.

Les classes per a principiants se centren en moviments bàsics, etiqueta i seguretat, i estan dissenyades per ajudar-vos a familiaritzar-vos amb la pràctica de l’aikido en un entorn de suport. No es requereix experiència prèvia.
