...
layout: page
title: Visitantes
description: Damos la bienvenida a los practicantes de aikido de todo el mundo que visitáis Barcelona y deseáis entrenar con nosotros. Tanto si venís por una estancia corta como si estáis considerando uniros a nuestro dojo, nos alegra recibiros.
...
- Vuestro nombre completo
- El nombre de vuestro dojo
- Vuestro grado
- El nombre de vuestro instructor
- La fecha(s) y clase(s) en las que deseáis participar

Esto nos ayuda a preparar y asegurar una experiencia fluida para todos en el tatami.

## Si queréis observar una clase

- Hacednos saber con antelación el día y la clase que queréis observar.
- Llegad al menos __15 minutos antes__ de que comience la clase.

La observación es una buena opción si sois nuevos en el dojo, venís por poco tiempo o simplemente tenéis curiosidad por nuestra práctica.

## Si queréis uniros a Aikido Musubi

__Principiantes__<br>
Si sois nuevos en aikido, recomendamos asistir a una __clase para principiantes__ antes de solicitar formalmente unirse al dojo.

Las clases para principiantes se centran en movimientos básicos, etiqueta y seguridad, y están diseñadas para ayudaros a familiarizaros con la práctica de aikido en un entorno de apoyo. No se requiere experiencia previa.
