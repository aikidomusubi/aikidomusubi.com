...
| `loc-barcelona-e.html` | **The recommendation.** C's structure and order, with the fact block redrawn in the site's own tokens and the steps and timetable taken from D. |
